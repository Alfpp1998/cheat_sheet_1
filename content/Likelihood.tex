...
\begin{align*}
\ell((X_1, X_2, \dots , X_ n, \theta)) &=\\ 
ln(L_n{(X_1, X_2, \dots , X_ n, \theta)})&=\\
...
* Massage second derivative or Hessian isolate functions of $X_i$ to use with $- \mathbf{E}(\ell ''(\theta ))$ or $-\mathbb E\left[\mathbf{H}\ell (\theta )\right]$.\\
